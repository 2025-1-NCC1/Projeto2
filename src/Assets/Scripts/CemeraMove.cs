...
public class CemeraMove : MonoBehaviour
{
   ...
   private float mouseX = 0.0f, mouseY = 0.0f; // declara variáveis e mantém ao iniciar o jogo a câmera sem nenhuma rotação
    ...
    void Update()
    {
        ...
        // Aplica a rotação à câmera (transform) com base nos valores acumulados
